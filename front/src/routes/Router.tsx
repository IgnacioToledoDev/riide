  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path="/" element={<Layout />} >
        ...
        <Route path="/signup" element={<Register />} handle={{ hideHeader: true} as RouteHandle} />
        ...
        <Route path="/forgot-password" element={<ForgotPasswordPage />} handle={{ hideHeader: true} as RouteHandle} />
        <Route path="/reset-password" element={<ResetPasswordPage />} handle={{ hideHeader: true} as RouteHandle} />
